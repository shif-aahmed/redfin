...
import './SanFranciscoHousesForSale.css'
...
function SanFranciscoHousesForSale() {
  ...
  const allProperties = [
    {
      id: 1,
      images: getPropertyImages(61, isCondosPage),
    ...
    {
      id: 2,
      images: getPropertyImages(62, isCondosPage),
      badges: ["REDFIN OPEN SAT, 1PM TO 4PM", "3D WALKTHROUGH"],
      price: "$1,895,000",
      beds: 3,
      baths: 2.5,
      sqft: 1800,
      address: "4567 Union St, San Francisco, CA 94123"
    },
    {
      id: 3,
      images: getPropertyImages(63, isCondosPage),
      badges: ["LISTED BY REDFIN", "3D & VIDEO TOUR"],
      price: "$2,450,000",
      beds: 4,
      baths: 3,
      sqft: 2400,
      address: "7890 Lombard St, San Francisco, CA 94133"
    },
    {
      id: 4,
      images: getPropertyImages(64, isCondosPage),
      badges: ["LISTED BY REDFIN", "3D WALKTHROUGH"],
      price: "$899,000",
      beds: 1,
      baths: 1,
      sqft: 750,
      address: "3214 Castro St, San Francisco, CA 94114"
    },
    {
      id: 5,
      images: getPropertyImages(65, isCondosPage),
      badges: ["REDFIN OPEN SUN, 12PM TO 3PM", "3D WALKTHROUGH"],
      price: "$1,550,000",
      beds: 2,
      baths: 2,
      sqft: 1400,
      address: "5678 Pacific Ave, San Francisco, CA 94115"
    },
    {
      id: 6,
      images: getPropertyImages(66, isCondosPage),
      badges: ["LISTED BY REDFIN", "3D & VIDEO TOUR"],
      price: "$2,100,000",
      beds: 3,
      baths: 3,
      sqft: 2100,
      address: "9876 California St, San Francisco, CA 94108"
    },
    {
      id: 7,
      images: getPropertyImages(67, isCondosPage),
      badges: ["REDFIN OPEN SAT, 2PM TO 5PM", "3D WALKTHROUGH"],
      price: "$1,125,000",
      beds: 2,
      baths: 1.5,
      sqft: 1100,
      address: "2345 Valencia St, San Francisco, CA 94110"
    },
    {
      id: 8,
      images: getPropertyImages(68, isCondosPage),
      badges: ["LISTED BY REDFIN", "3D WALKTHROUGH"],
      price: "$3,250,000",
      beds: 5,
      baths: 4,
      sqft: 3200,
      address: "6789 Fillmore St, San Francisco, CA 94115"
    }
  ]
        ...
        <div className="sanfrancisco-properties-container">
          <div className="sanfrancisco-properties-scroll-container">
            {properties.map((property) => {
              ...
              <div 
                key={property.id} 
                className="sanfrancisco-property-card"
                onMouseEnter={() => setHoveredCard(property.id)}
                onMouseLeave={() => setHoveredCard(null)}
              >
                <div className="sanfrancisco-property-image-wrapper">
                  <img 
                    src={currentImage} 
                    alt={property.address}
                    className="sanfrancisco-property-image"
                    loading="lazy"
                  />
                  {hoveredCard === property.id && (
                    <>
                      <button 
                        className="sanfrancisco-image-nav-btn sanfrancisco-image-nav-left"
                        onClick={(e) => {
                          e.stopPropagation()
                      ...
                      <button 
                        className="sanfrancisco-image-nav-btn sanfrancisco-image-nav-right"
                        onClick={(e) => {
                          e.stopPropagation()
                  ...
                  <div className="sanfrancisco-property-badges">
                    {property.badges.map((badge, index) => {
                      ...
                      return (
                        <span 
                          key={index} 
                          className={`sanfrancisco-badge ${isRedBadge ? 'sanfrancisco-badge-red' : 'sanfrancisco-badge-purple'}`}
                        >
                          {badgeText}
                        </span>
                      )
                ...
                <div className="sanfrancisco-property-details">
                  <div className="sanfrancisco-property-price-row">
                    <span className="sanfrancisco-property-price">{property.price}</span>
                    <button 
                      className={`sanfrancisco-favorite-btn ${favorites[property.id] ? 'sanfrancisco-favorite-active' : ''}`}
                  ...
                  <div className="sanfrancisco-property-specs">
                  ...
                  <div className="sanfrancisco-property-address">{property.address}</div>
                </div>
              </div>
              )
            })}
          ...
          <button 
            className="sanfrancisco-scroll-button"
            onClick={scrollRight}
...
export default SanFranciscoHousesForSale
