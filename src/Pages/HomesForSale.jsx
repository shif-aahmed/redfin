...
function HomesForSale() {
  return (
    <div className="homes-for-sale-page">
      <div className="homes-for-sale-container">
        <div className="homes-for-sale-content">
          <div className="homes-for-sale-left">
            <h1 className="homes-for-sale-heading">Houses for sale near me</h1>
            <p className="homes-for-sale-description">
              Find houses for sale near you. View photos, open house information, and property details for nearby real estate.
            </p>
          </div>
          <div className="homes-for-sale-right">
