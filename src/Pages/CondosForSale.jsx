import './CondosForSale.css'

function CondosForSale() {
  return (
    <div className="condos-for-sale-page">
      <div className="condos-for-sale-container">
        <div className="condos-for-sale-content">
          <div className="condos-for-sale-left">
            <h1 className="condos-for-sale-heading">Condos for sale near me</h1>
            <p className="condos-for-sale-description">
              Find condos for sale near you. View photos, open house information, and property details for nearby real estate.
            </p>
          </div>
          <div className="condos-for-sale-right">
