...
function LandForSale() {
  return (
    <div className="land-for-sale-page">
      <div className="land-for-sale-container">
        <div className="land-for-sale-content">
          <div className="land-for-sale-left">
            <h1 className="land-for-sale-heading">Land for sale near me</h1>
            <p className="land-for-sale-description">
              Find land for sale near you. View photos, prices, and property details for nearby real estate.
            </p>
          </div>
          <div className="land-for-sale-right">
